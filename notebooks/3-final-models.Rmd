...
mse_1 <- mean( (boot_xi_1_hat[-108]-boot_xi_1[-108])^2 ) 
...
```{r}
c(lower = sum(N_1^(.582307672+-0.002792677*ukr_1)), upper= sum(N_1^(0.7162209+0.1931608*ukr_1)))
spin(boot_xi_1, lower = 0)
quantile(boot_xi_1, probs = c(0.025, 0.975))

c(lower = sum(N_2^(0.5930046+-0.0134986*ukr_2)), upper= sum(N_2^(0.7521351+0.2208545*ukr_2)))
spin(boot_xi_2, lower = 0)
quantile(boot_xi_2, probs = c(0.025, 0.975))
